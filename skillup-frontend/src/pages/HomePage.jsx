  ...
  return (
    <div className="bg-white text-slate-900 font-sans">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-slate-900 text-white">
        {/* Abstract shapes */}
        <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/2 w-[600px] h-[600px] bg-cyan-500/10 rounded-full blur-3xl"></div>
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-cyan-400 text-xs font-bold tracking-wider uppercase mb-8">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight mb-8">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-indigo-400">Personalized AI Mentoring.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/register">
              <Button className="px-8 py-4 bg-cyan-600 hover:bg-cyan-500 text-white text-lg shadow-xl shadow-cyan-900/20">
                Start Learning Now
              </Button>
            </Link>
            <Link to="/login">
              <button className="flex items-center gap-2 px-8 py-4 text-white hover:text-cyan-400 transition-colors font-semibold group">
                <div className="flex items-center justify-center w-10 h-10 rounded-full border border-white/20 group-hover:border-cyan-400 group-hover:bg-cyan-400/10 transition-all">
                    <Icons.Play />
                </div>
                See How It Works
              </button>
      ...
      <section className="py-24 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-sm font-bold text-cyan-600 uppercase tracking-widest mb-3">Core Features</h2>
            <p className="text-3xl md:text-4xl font-bold text-slate-900">Designed for modern education.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="p-8 rounded-3xl border border-slate-100 bg-slate-50/50 hover:bg-white hover:shadow-xl hover:shadow-slate-200/60 transition-all duration-300">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row items-center gap-16">
                <div className="flex-1">
                    ...
                    <div className="space-y-6">
                        {[
                            ...
                            <div key={i} className="flex items-center gap-4">
                                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-cyan-100 text-cyan-600 flex items-center justify-center">
                                    <Icons.Check />
                                </div>
                    ...
                    <div className="mt-10">
                        <Link to="/register">
                            <Button className="px-8 py-3 bg-slate-900 text-white hover:bg-slate-800">Explore the Platform</Button>
                        </Link>
                    </div>
                </div>
                    ...
                    <div className="relative z-10 rounded-3xl overflow-hidden shadow-2xl border-8 border-white">
                        <div className="aspect-video bg-slate-200 flex items-center justify-center">
                             ...
                             <div className="text-center p-8">
                                <div className="w-16 h-16 rounded-full bg-white flex items-center justify-center mx-auto mb-4 shadow-lg text-cyan-600">
                                    <Icons.Play />
                                </div>
                                <p className="text-sm font-bold text-slate-400 uppercase tracking-widest">Platform Preview</p>
                             </div>
                        </div>
                    </div>
                    {/* Decorative elements */}
      ...
      <section className="py-24 bg-white">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <div className="bg-gradient-to-r from-cyan-600 to-indigo-700 rounded-[3rem] p-12 md:p-20 text-center text-white relative overflow-hidden shadow-2xl">
                <div className="relative z-10">
                    <h2 className="text-3xl md:text-5xl font-extrabold mb-6">Ready to reach your potential?</h2>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                         <Link to="/register">
                            <Button className="px-10 py-4 bg-white text-slate-900 hover:bg-slate-100 text-lg font-bold">Create Free Account</Button>
                         </Link>
                         <p className="text-sm text-cyan-200">No credit card required</p>
                    </div>
                </div>
                {/* Decoration */}
